...
function handleAudioUpload(req, res){
    ...
    if(!valid){
        ...
        insertSpeechIntoDatabase(req, res);
    }
}
...
function insertSpeechIntoDatabase(req, res){
    // Read from uploads
...
function requireLogin (req, res, next) {
    if (!req.session.user) {
        res.redirect('/checkUserCredentials');
    } else {
        next();
    }
}
...
module.exports = {
    ...
    cloudant : {
        ...
        insertSpeechIntoDatabase : insertSpeechIntoDatabase,
