...
function DroneHandler(MQTT, cloudant, droneName){
	this.cloudant = cloudant;
	this.MQTT = MQTT;
	this.droneName = droneName;


	this.currentMode = new ModeNormal(this.cloudant, this.MQTT, droneName);
...
DroneHandler.prototype.setMode = function(modeType){
	...
	switch(modeType){
		case Normal:
			this.currentMode = new ModeNormal(this.cloudant, this.MQTT, this.droneName);
			break;
		case Fire:
			this.currentMode = new ModeFire(this.cloudant, this.MQTT, this.droneName);
			break;
		case "Interact":
			this.currentMode = new ModeInteract(this.cloudant, this.MQTT, this.droneName);
			break;
		case "Avoidance":
			this.currentMode = new ModeAvoidance(this.cloudant, this.MQTT, this.droneName);
			break;
		default:
