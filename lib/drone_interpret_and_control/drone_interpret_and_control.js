...
InterpretAndControl.prototype.checkHandlerExistence = function(droneName){
    if(this.handlers[droneName] === undefined){
        this.handlers[droneName] = new DroneHandler(this.MQTT, this.Cloudant, droneName);
    }
};

InterpretAndControl.prototype.getModeName = function(droneName){
    this.checkHandlerExistence(droneName);
    return this.handlers[droneName].currentMode.name();
};

InterpretAndControl.prototype.setMode = function(droneName, modeType){
    this.checkHandlerExistence(droneName);
...
InterpretAndControl.prototype.processImageLabels = function(droneName, keywords, time, location){
    this.checkHandlerExistence(droneName);
...
InterpretAndControl.prototype.processSpeechTranscript = function (droneName, transcript, time, location){
    this.checkHandlerExistence(droneName);
...
InterpretAndControl.prototype.reset = function(droneName){
    this.checkHandlerExistence(droneName);
    this.handlers[droneName].currentMode = new ModeNormal(this.cloudant, this.MQTT);
...
InterpretAndControl.prototype.updateSensorReadings = function(droneName, sensorReadings){
    this.checkHandlerExistence(droneName);
...
*/
InterpretAndControl.prototype.test = function(droneName){
    this.checkHandlerExistence(droneName);
    this.handlers[droneName].currentMode.test()
};

InterpretAndControl.prototype.sendImageAlert = function(droneName){
...
// function InterpretAndControl(MQTT, cloudant, drones){
//     this.cloudant = cloudant;
//     this.MQTT = MQTT;
//
