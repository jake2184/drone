...
MqttHandler = function(mqttCreds, statusCallback){
   ...
   // client.log.setLevel('debug');
    ...
    this.org = mqttConfig.org;

    this.client = client;
};

// Publish a command
MqttHandler.prototype.sendCommand = function(deviceType, deviceId, commandType, format, data, inQoS){
    var client = this.client;
    var QoS = inQoS || 0;
    client.publishDeviceCommand(deviceType, deviceId, commandType, format, data, QoS);
    //client.on("connect", function(){
